 ...
 * CLI version: 2.11.0
 * 
 * Generated: Tue, 18 Jul 2023 13:11:12 GMT
 */

var APP_com_domain_app_clock = (function () {
  'use strict';
  ...
  class App extends Lightning$1.Component {
    constructor() {
       ...
       */
      _defineProperty(this, "Background", this.getByRef("Background"));
      _defineProperty(this, "ClockBG", this.getByRef("ClockBG"));
    }
    static _template() {
      return {
        w: 1920,
        ...
        Shadow: {
          ...
          texture: Lightning$1.Tools.getShadowRect(950, 320, 20, 10, 20)
        },
        ClockBG: {
          w: 920,
          h: 300,
    ...
    static getFonts() {
      return [{
        ...
        family: "Orbitron",
        url: Utils.asset("fonts/Orbitron-Regular.ttf")
      }];
    }
    _init() {
